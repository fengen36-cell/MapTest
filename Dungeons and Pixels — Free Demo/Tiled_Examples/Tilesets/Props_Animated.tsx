...
<tileset version="1.10" tiledversion="1.11.0" name="Props_Animated" tilewidth="32" tileheight="32" tilecount="14" columns="7">
 <image source="../../Tilesets/Props_Animated.png" width="224" height="64"/>
 <tile id="0">
  <animation>
